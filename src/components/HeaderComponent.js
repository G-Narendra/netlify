    ...
    return (
      <header id="home" className="header">
        <div className="profile-image">
          <img src={`${process.env.PUBLIC_URL}/images/portfolio image.png`} alt="Profile" />
        </div>
        <div className="intro">
          <h1>I'm Narendra Gandikota.</h1>
          <h2>Student (BTech IV year)</h2>
          ...
          {showMore && (
            <div className="extra-info">
              ...
              <p>
                When I'm not immersed in data, you can find me indulging in my hobbies such as  playing chess, and listening to music. These activities help me maintain a balanced lifestyle and fuel my creativity. I believe in continuous improvement and am always looking for opportunities to grow both personally and professionally.
              </p>
            </div>
          )}
        </div>
